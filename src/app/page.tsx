...
export default function Home() {
  const reportes:reporte[] = [
    ...
    {titulo:'Ventas por categorías', descripcion:'Las categorías ordenadas según la cantidad de órdenes que ha recibido.', numero:3},
    {titulo:'Ranking de productos', descripcion:'Un ranking de todos los productos segun cuántos han vendido.', numero:4},
